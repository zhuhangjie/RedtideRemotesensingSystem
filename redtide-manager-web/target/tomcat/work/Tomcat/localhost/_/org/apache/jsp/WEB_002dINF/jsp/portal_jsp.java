 ...
 * Generated at: 2018-03-28 08:04:11 UTC
...
public final class portal_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("        },\r\n");
      out.write("    baseUrl = \"http://localhost:8090/iserver/services/map-sampleworkspace/rest/maps/\"\r\n");
      out.write("\turl1 = \"http://localhost:8090/iserver/services/map-sampleworkspace/rest/maps/chl2016_11_09map\";\r\n");
      out.write("\turl2 = \"http://localhost:8090/iserver/services/map-sampleworkspace/rest/maps/RT2016_11_09map\";\r\n");
      ...
      out.write("\t\t//把显示的距离值更改为回显的值\r\n");
      out.write("\t\t$(\"#area_result\").html(\"测量结果:\" + tempResult + \"平方米\"); \r\n");
      out.write("\t\t//让无云图时的提示字样在正常情况下隐藏\r\n");
      out.write("\t\t$(\"#cloudError\").css(\"display\",\"none\");\r\n");
      out.write("\t\tvar date_Info = $(\"#dateInfo\").val(); \r\n");
      out.write("\t\tdate_nomal = date_Info.split('_').join('-');\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\r\n");
      out.write("\t    var cloudSrc = ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write(" + \"/cloud\" + date_nomal + \".jpg\"; \r\n");
      out.write("\t    \r\n");
      out.write("\t    \r\n");
      out.write("\t    \r\n");
      ...
      out.write("\t    map.addLayers([layer1, layer2, lineLayer, polygonLayer]);\r\n");
      out.write("\t\tmap.setCenter(new SuperMap.LonLat(122.31, 30.16), 4);\r\n");
      out.write("    }\r\n");
      out.write("\t\r\n");
      ...
      out.write("        var myyear = date.getFullYear();     \r\n");
      out.write("        var mymonth = date.getMonth()+1;     \r\n");
      out.write("        var myweekday = date.getDate();      \r\n");
      out.write("             \r\n");
      out.write("        if(mymonth < 10){     \r\n");
      out.write("            mymonth = \"0\" + mymonth;     \r\n");
      out.write("        }      \r\n");
      out.write("        if(myweekday < 10){     \r\n");
      out.write("            myweekday = \"0\" + myweekday;     \r\n");
      out.write("        }     \r\n");
      out.write("        return (myyear+\"_\"+mymonth + \"_\" + myweekday);      \r\n");
      out.write("    }      \r\n");
      out.write("\t\r\n");
      out.write("  \t//测量结束调用事件\r\n");
      ...
      out.write("        $(\"#area_result\").html(\"测量结果:\" + rt_distance + \"米\"); \r\n");
      out.write("    }\r\n");
      out.write("\t\r\n");
      out.write("  //测量结束调用事件\r\n");
      ...
      out.write("        $(\"#area_result\").html(\"测量结果:\" + rt_area + \"平方米\"); \r\n");
      out.write("    }\r\n");
      out.write("  \r\n");
      out.write("  \t//移除图层要素\r\n");
      ...
      out.write("  \t}\r\n");
      out.write("  \t\r\n");
      out.write("  \t//没有云图信息时显示无云图\r\n");
      out.write("  \tfunction alertError() {\r\n");
      out.write("  \t\t $(\"#cloudError\").css(\"display\",\"block\");\r\n");
      out.write("  \t} \r\n");
      out.write("  \t\r\n");
      ...
      out.write("\t\t    <li><a href=\"javascript:void(0)\">当前日期:</a></li>\r\n");
      out.write("\t\t    \r\n");
      out.write("\t\t    <li style=\"top:8px;right: 6px\">\r\n");
      out.write("\t\t    \t<!-- 日期控件，回显老格式的数据信息 -->\r\n");
      out.write("\t\t    \t<input id=\"dateInput\" size=\"16\" type=\"text\" value=\"");
      ...
      out.write("\" readonly class=\"form_date\"> \r\n");
      out.write("\t\t    \t<input class=\"btn btn-default\" type=\"submit\" value=\"Submit\" onclick=\"findPic()\">\r\n");
      out.write("\t\t    </li>\r\n");
      out.write("\t\t    \r\n");
      out.write("\t\t    <li>\r\n");
      out.write("\t\t\t    <div id=\"modelButton\" class=\"btn-group\" role=\"group\" aria-label=\"...\">\r\n");
      out.write("\t\t\t\t  <button id=\"btnchl\" type=\"button\" class=\"btn btn-primary\" onclick=\"toChlModel()\">叶绿素</button>\r\n");
      out.write("\t\t\t\t  <button id=\"btnrt\" type=\"button\" class=\"btn btn-default\" style=\"width: 68px\" onclick=\"toRTModel()\">赤    潮</button>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</li>\r\n");
      ...
      out.write("\t        <li><a href=\"#\" onclick=\"clickCloudButton()\">遥感云图<span class=\"sr-only\">(current)</span></a></li>\r\n");
      ...
      out.write("\t          </ul>\r\n");
      out.write("\t        </li> \r\n");
      out.write("\t        <li><a id=\"area_result\" value=\"\" href=\"#\">测量结果:</a></li> \r\n");
      out.write("\t        <li style=\"top:8px;right: 6px\">\r\n");
      out.write("\t\t    \t<input class=\"btn btn-default\" type=\"submit\" value=\"保存\" onclick=\"saveArea()\">\r\n");
      out.write("\t\t    </li>\r\n");
      out.write("\t      </ul>\r\n");
      ...
      out.write("\t      <img id=\"cloudImage\" src=\"\" style=\"height:500px;weight:500px\" onerror=\"alertError()\">\r\n");
      out.write("\t      <span id=\"cloudError\" style=\"display:none\">无赤潮信息</span>\r\n");
      out.write("\t    </div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t<!-- 图表弹出层 -->\r\n");
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/portal.jsp(508,10) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/portal.jsp(511,10) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f1.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${requestScope.user == null}", java.lang.Boolean.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false)).booleanValue());
